    ...
    def get_publishing_date(self, url, doc):
        ...
        PUBLISH_DATE_TAGS = [
            ...
            {'attribute': 'pubdate', 'value': 'pubdate',
             'content': 'datetime'},
            {'attribute': 'itemprop', 'value': 'datePublished dateModified', 
            'content': 'content'},
            {'attribute': 'name', 'value': 'article:published_time', 
            'content': 'content'},
            {'attribute': 'class', 'value': 'dt-updated', 
            'content': 'datetime'},
            {'attribute': 'class', 'value':'entry-date published', 'content': 'datetime'}
        ]
